...
TOP_LEVEL_NAME="fp_converter_arria10"
QSYS_SIMDIR="./../"
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvhdl -v93 $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/../altera_fp_functions_160/sim/fp_converter_arria10_altera_fp_functions_160_bukosui.vhd" -work altera_fp_functions_160 -cdslib ./cds_libs/altera_fp_functions_160.cds.lib
  ncvlog -compcnfg $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/fp_converter_arria10.v"                                                                                                                                                  
fi
