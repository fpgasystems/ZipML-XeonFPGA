...
if [ $SKIP_FILE_COPY -eq 0 ]; then
  cp -f $QSYS_SIMDIR/../altera_fp_functions_160/sim/fp_div_arria10_altera_fp_functions_160_ffbveaa_memoryC1_uid115_invTables_lutmem.hex ./
  cp -f $QSYS_SIMDIR/../altera_fp_functions_160/sim/fp_div_arria10_altera_fp_functions_160_ffbveaa_memoryC0_uid112_invTables_lutmem.hex ./
  cp -f $QSYS_SIMDIR/../altera_fp_functions_160/sim/fp_div_arria10_altera_fp_functions_160_ffbveaa_memoryC2_uid118_invTables_lutmem.hex ./
fi
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvhdl -v93 $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/../altera_fp_functions_160/sim/fp_div_arria10_altera_fp_functions_160_ffbveaa.vhd" -work altera_fp_functions_160 -cdslib ./cds_libs/altera_fp_functions_160.cds.lib
  ncvlog -compcnfg $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/fp_div_arria10.v"                                                                                                                                                  
fi
