...
if [ $SKIP_COM -eq 0 ]; then
  ...
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../altera_fp_functions_160/sim/fp_gt_arria10_altera_fp_functions_160_jgnu7ly.vhd" -work altera_fp_functions_160
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS  "$QSYS_SIMDIR/fp_gt_arria10.v"                                                                                               
fi
