...
# ACDS 16.0 211 linux 2018.10.09.13:21:45
# ----------------------------------------
...
# # End of template
# ----------------------------------------
# If fp_gt_arria10 is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "fp_gt_arria10"
}
...
alias com {
  ...
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS       "$QSYS_SIMDIR/../altera_fp_functions_160/sim/fp_gt_arria10_altera_fp_functions_160_jgnu7ly.vhd" -work altera_fp_functions_160
  eval  vlog -v2k5 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/fp_gt_arria10.v"                                                                                               
}
