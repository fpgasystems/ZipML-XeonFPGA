...
# ACDS 16.0 211 linux 2018.10.10.12:42:53
# ----------------------------------------
...
# # End of template
# ----------------------------------------
# If fp_exp_arria10_nohard is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "fp_exp_arria10_nohard"
}
...
alias com {
  ...
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS       "$QSYS_SIMDIR/../altera_fp_functions_160/sim/fp_exp_arria10_nohard_altera_fp_functions_160_724m2py.vhd" -work altera_fp_functions_160
  eval  vlog -v2k5 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/fp_exp_arria10_nohard.v"                                                                                               
}
